    ...
    return (
        <div>
            <div className='Softwaremsg-card'>
                ...
                />
                <div className='Softwaremsg-name'>CATIA P3 V5R21</div>
                <div className='Softwaremsg-type'>研发设计</div>
                ...
                <div className='Softwaremsg-content'>CATIA是产品设计和体验解决方案。它被多个行业的领先组织用于开发我们在日常生活中看到和使用的产品。通过提供由 3DEXPERIENCE 平台支持的设计和工程解决方案,CATIA 可提升任何行业内任何规模公司的创新能力。</div>
